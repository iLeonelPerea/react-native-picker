            ...
            <Modal
                ...
                <View style={styles.basicContainer}>
                    <View style={[styles.modalContainer,this.props.style]}>
                        <View style={{backgroundColor:'#FFFFFF',height: 0.5,width: SCREEN_WIDTH}}/>
                        <View style={styles.buttonView}>
                            <TouchableOpacity style={[styles.button,styles.buttonLeft]} onPress={() => {
                                    this.props.onCancel();
                                    this.setState({modalVisible: false});
                                }}>
                                <Text style={styles.buttonTextLeft}>{this.lang.BTN_CANCEL}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.button,styles.buttonRight]} onPress={() => {
                                ...
                                <Text style={styles.buttonTextRight}>{this.lang.BTN_CONFIRM}</Text>
                            </TouchableOpacity>
                        </View>
